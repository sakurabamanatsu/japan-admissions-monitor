...
监控范围包括学部入试，以及大学院、研究科、修士和博士课程中的外国人留学生入试信息。
当前只展示 `2027年度（令和9年度）` 的结果；网页更新于 2026 年不代表入学年度是 2027 年。
PDF 会优先读取前 5 页正文确认入学年度；无法提取文字时才根据标题和文件网址判断。

## 工作方式

- GitHub Actions 在日本时间每天 08:30–17:45 每 15 分钟运行一批
- 学校分为 4 批，每所大学约每小时检查一次
